...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: "Kit365.ir - everyday you may need something. ",
    description:
      "Kit365 provide Time, Sharia Times, Map, Distance, Area, Unit Conversion's and other tools",
    creator: "Innofinity",
  },
  metadataBase: new URL("https://kit365.ir"),
  alternates:{
    canonical:"/"
  },
  themeColor: "#FFF",
